...
#ENTRYPOINT ["kosond", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=44044", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=44045", "--non-interactive", "--confirm-external-bind"]
